...
5.times do |post|
 posts << Post.create(title: Faker::Lorem.sentence(3, true, 4), content: Faker::Lorem.paragraph(20, true, 10), user: users.sample)
end

20.times do |comment|
  comments << Comment.create(content: Faker::Lorem.paragraph(2), post: posts.sample, user: users.sample)
end